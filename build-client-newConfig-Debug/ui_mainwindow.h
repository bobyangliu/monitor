...
**
** Created: Thu Apr 24 10:31:50 2014
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        Receive = new QTextEdit(centralWidget);
        Receive->setObjectName(QString::fromUtf8("Receive"));
        Receive->setGeometry(QRect(33, 173, 231, 101));
        connectButton = new QPushButton(centralWidget);
        connectButton->setObjectName(QString::fromUtf8("connectButton"));
        connectButton->setGeometry(QRect(290, 170, 87, 27));
        stopButton = new QPushButton(centralWidget);
        stopButton->setObjectName(QString::fromUtf8("stopButton"));
        stopButton->setGeometry(QRect(290, 210, 87, 27));
